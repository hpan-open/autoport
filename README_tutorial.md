...
* It may be a time-consuming process, to develop an initial ports
  ...
  'build' 
    * The time-consuming nature of the ports build process is
      ...
      Poudriere. Build failures can be easily diagnosted, by reviewing
      log files. Build failures can be addressed with individual with
      port reconfiguration, port update, or discussions in issue
      tracking
* Effects of specific port configuration selections may not seem
  ...
  dependencies may be added as by way of immediate dependencies, and
  by  way of dependencies introduced by immediate dependencies.
